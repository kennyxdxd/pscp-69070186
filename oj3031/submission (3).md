...
```text
input จะเป็นการใส่อัตราเร็ว เเละจำนวนของบ้านที่ให้เราตรวจสอบ เเละตำเเหน่งของบ้าน โดยโจทย์นี้ต้องการoutput ออกมาเป็นเวลา หน่วยวินาที โดยจะเป็นเวลาที่บ้านจะโดนนํ้าหมึกท่วม
```
...
```text
เหมือน ผมใช้ Loop เเละคำนวนพิกัตเหมือนเดิม
```
