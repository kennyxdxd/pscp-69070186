...
```text
เป็นหารปลูกดอกไม้เป็นเเนวเเทยงไปเรื่อยๆโดยจะมีความหนาเท่ากับ n โดยโจทย์จะให้เราหาดอกไม้ดอกสุดท้ายว่าอยู่ที่ไหน
input
รับจำนวนเต็ม 2 ตัวในบรรทัดเดียวกัน 
l: ความหนาของแถบแนวทแยงในการปลูก
n: จำนวนช่องดอกไม้ทั้งหมดที่เราปลูก
output จำนวนเเถว
```
...
```text
step 1 รับค่าinput มา
step 2 ใช้ while ตรวจโดย sums ต้องมากกว่า n โดยกำหนด sums = 0 ก่อน
step 3 ใช้สูตรคำนวนหาคาบก่อนหน้า
step 4 หา คาบต่อไป โดยใช้อีกสูตร
step 5 เอาสูตรเเรกมาลบสูตรหลังเพื่อหาว่าในคาบนั้นมี่เลขอะไรบ้าง
Step 6 count += 1
step 7 print คำตอบ
```
...
```text
เเผนเเรกของผมเหมือนเเผนท้าย โดยใช้สูตรนี้ในการหาคาบ(idx * (idx+1)) // 2เเละ((idx - l) * (idx - l + 1)) // 2
...
ทำไมเลือก case นี้:เป็นเคสที่ค่าเยอะมากๆ
...
ทำไมเลือก case นี้:เป็นเคสที่น้อยมากๆ
...
ทำไมเลือก case นี้:เป็นเลข ปลานกลาง
