...
```text
โจทย์จะมี อิฐก้อนเล็ก เเละก้อนใหญ่มาให้โดยต้องการให้เราหาว่า เราจะใช้หินก้อนเล็กกี่ก้อนโดยจะต้องรับค่า ความยาวของสะพานเเละต้องใช้หินก่อนใหญ่ก่อน จากนั้นถึงจะใช้หินก้อนเล็กได้ เเละให้เเสดงจำนวนหินก้อนเล็กที่เราใช้ ถ้าไม่สามารถสร้างได้ใส่ -1
```
...
```text
ตรวจสอบว่า ความยาวสะพานหารปัดเศษด้วย 5 มีค่ามากกว่าหรือเท่ากับ อิธใหญ่หรือปล่าวถ้าใช้ให้ เอาอิธไปคูณ 5
ถ้าไม่ใช้ ให้ เอา ความยาวสะพานไป modulo กับ 5 เพราะว่าเรามี อิฐใหญ่มากกว่า ความยาวจึงหาเศษเหลือเพื่อมาคำนวนอิฐก้อนเล็ก
ตรวจสอบว่า อิฐก้อนเล็กมีพอหรือไม่ ถ้าไม่ ปริ้น -1
นอกนั้น print ความยาวของ gold ที่เหลือ
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก ตรวจสอบว่า ความยาวสะพานหารปัดเศษด้วย 5 มีค่ามากกว่าหรือเท่ากับ อิธใหญ่หรือปล่าวถ้าใช้ให้ เอาอิธไปคูณ 5เพราะ ว่า สะพานยาวกว่าอิฐใหญ่
```
...
```text
ได้เห็นcase ปกติที่สะพานพอกับอิฐ
```
...
```text
ได้เห็นcase ที่สะพานไม่พอกับอิฐ
```
...
```text
ได้เห็นcase ที่ไม่ต้องใช้อิฐก้อนเล็ก
```
