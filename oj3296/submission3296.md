...
```text
เป็นการผสมสี โดยจะหาค่าเฉลียขอเเต่ละค่าของ RGB มาเพื่อหาสีที่ผสมเเล้ว
input:
ตัวเลข RGB ตัวที่หนึง
ตัวเลข RGB ตัวที่สอง
output 
ผลลัพท์ตัวที่ผสมเเล้ว
```
...
```text
step 1 รับค่า RGB มาทั้งสองตัว
step 2 print ออกมาเเล้วหาค่าโดย เอา ตัวมาบวกกันเเล้ว หาร2 จากนั้นใช้ math.floor ปัดเศษลง
```
...
```text
เเผนเสองของฉันเหมือนกับเเผนเเรก โดยใช้ math เพื่อปัดเศษลง
```
...
ทำไมเลือก case นี้:เคสที่ทุกอย่างเป็น 0
...
ทำไมเลือก case นี้:เคสที่ตัวเลขเเตกต่างกัน
