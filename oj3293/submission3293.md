...
```text
ให้เอาค่าที่รับมา 5 บรรทัดเเละเอาเครืองหมานดอกจันทร์มาลอมรอบโดยกลอปเท่ากับตัวที่มากที่สุด
```
...
```text
step1 loop รับinput มา 5 ครั้งใส่ List ไว้
step2 หาคำที่่ยาวที่สุดโดยใช้ max
step3 สร้างเส้นนบนล้าง
step4 loop print คำทั้งหมด
step5 printเส้นล่าง
```
...
```text
เเผนสุดท้ายของฉันเหมือนกับเเผนเเรก ใช้max เพื่อหาตัวอักษรที่ยาวที่สุด
```
...
ทำไมเลือก case นี้:เป็นเคสที่ตัวอักษรสั้น
...
ทำไมเลือก case นี้:เป็นเคสที่ตัวอักษรยาว
...
ทำไมเลือก case นี้:เคสที่ตัวอักษรยาวมาก

Input:

```text
Across the border, silent and grey,
The light of the morning is stolen away.
No birds in the canopy, no songs in the air,
Only the weight of a quiet despair.
The banners are raised in the fever of pride,
```
