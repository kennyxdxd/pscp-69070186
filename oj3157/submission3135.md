...
```text
loop ตามจำนวน N ถ้า + เพิ่ม 10 คะเเนน - ลบ 5 คะเเนน
```
...
```text
Step 1: อ่านจำนวนเต็ม N ซึ่งเป็นจำนวนครั้งของการกระทำ
Step 2: กำหนดตัวแปรสำหรับเก็บคะแนนเริ่มต้นให้เป็น 0
Step 3: วนลูปอ่านเครื่องหมายคำสั่งทั้งหมด N
Step 4: ในแต่ละรอบของการวนลูป ถ้าเป็น + ให้บวกคะแนนเพิ่ม 10 ถ้าเป็น - ให้ลบคะแนนออก 5 
Step 5: พิมพ์ค่าคะแนนรวมสุดท้าย
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก ใช้ลูปวนรับค่าคำสั่ง + หรือ -
```
