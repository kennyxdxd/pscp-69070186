...
```text
หาจำนวนครั้งที่น้อยที่สุดในการกระโดดของกบเพื่อให้ได้ระยะทางรวมอย่างน้อยเท่ากับเป้าหมาย โดยการกระโดดครั้งแรกได้ระยะทาง X เมตร และครั้งถัดๆ ไปจะกระโดดได้ลดลงครั้งละ 2 เมตร หากกระโดดจนระยะลดลงเหลือ 0 หรือติดลบแล้วแต่ยังทำระยะรวมไม่ถึงเป้าหมาย ให้ตอบ -1
Input:
...
```text
Step 1: อ่านค่าจำนวนเต็ม X และ Y
Step 2: กำหนดให้ตัวแปรเก็บjumps= 0 และ ตัวแปรนับจำนวนครั้ง = 0
Step 3: ใช้while ตราบใดที่ระยะทางสะสมยังน้อยกว่า Y และ ระยะการกระโดดปัจจุบัน มากกว่า 0
นำ X ไปบวกเพิ่มในระยะทางสะสมลดค่า X ลง 2เพิ่มจำนวนครั้งการกระโดดขึ้น 1
Step 4: ตรวจสอบว่าระยะทางสะสมถึง Y หรือไม่ถ้าระยะทางสะสม >=Y ให้แสดงจำนวนครั้งการกระโดดถ้าไม่ถึง ให้แสดง -1
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ใช้wile loop ในการloop
```
