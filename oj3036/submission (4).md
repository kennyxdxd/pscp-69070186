...
```text
ต้องการให้ใช้ระยะทางที่สั้นที่สุดในการพังกำเเพงเพื่อไปท่หมายเลข 1 โดย ค่า input จะอยู่ที่(1 <= N <= 100,000) โดยถ้าเป็นสามเหลียมหัวควํ่าเราจะสามารถทะรุผ่านไปได้เลย
```
...
```text
หาว่าเราอยู่บรรทัดไหนก่อน
เช็กว่าบรรทัดเป็นเลขขี้หรือปล่าว เเละ ตัวเลขเป็นเลขคู่ไหม ถ้าใช้ เอาบรรทัดไปคูณสอง เเล้วลบสาม
เช็กว่าบรรทัดเป็นเลขคู่หรือปล่าว เเละ ตัวเลขเป็นเลขขี้ไหม ถ้าใช้ เอาบรรทัดไปคูณสอง เเล้วลบสาม
ถ้าไมใช้
เอาบรรทัดไปคูณสอง เเล้วลบสอง
```
...
```text
เหมือนแผนแรก ใช้ math.sqar มาหารเเละ ใช้ .ceil มาปัดเศษ เเล้วนำมาตราจด้วย If else ต่อ
```
...
```text
เป็นตัวเลขเเถวเเรกต้องออกเป็น เเถมเดียวไม่ใช้สองเเถว
```
