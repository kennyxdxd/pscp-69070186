...
```text
โดยจะเป้นการวนของขวันตามจำนวน K โดยจะหมดตามเข็มนาฬิกาโดยเริ่มจากคนที่ 1 เเล้วส่งไปเรื่่ยๆ จน ของขวัญวนกลับมาที่คนที่ 1หรือ ของขวัญวนมาให้ขโมยพิจารณาตรวจสอบ  
Input 
N จำนวน คน
K ระยะการส่งต่อของขวัญข้ามไปกี่คน
T หมายเลขของคนที่เป็นขโมย
output
พิมพ์จำนวนเต็ม 1 ตัว แสดงจำนวนคนที่ได้พิจารณาของขวัญทั้งหมด
```
...
```text
step 1 รับค่า  NKT
step 2 กำหนดให้ตำแหน่งปัจจุบันอยู่ที่คนที่ 1
Step 3: ตรวจสอบว่าถ้าคนที่ 1 เป็นขโมยตั้งแต่แรก current == Tให้แสดงผลค่า count 
Step 4: ถ้าไม่ใช่ขโมย ให้วนลูปทำงานไปเรื่อย
ตรวจว่า ex + k น้อยกว่าเท่ากับ จำนวนคนไหม
ถ้าไม่
ex = (ex + k) - n
ถ้า ex == 1 หยุด loop
ภ้า ex เท่ากับ tหยุดloop เเล้วบวก จำนวนคน
ส่งของขวัญไปให้คนถัดไปอีก K คน
step 5 print(count)
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ใช้สูตรนี้หาถ้าคนเกินจำนวนex = (ex + k) - n
```
...
```text
หนึ่งค่าเหนือค่าสูงสุดที่โจทย์ยกตัวอย่าง
```
