...
```text
โคยโจทย์ต้องการให้เปรียบเทียบ คะเเนนของตชคนที่ได้มากที่สุด กับคนที่น้อยที่สุดว่ามีโอกาสที่คะเเนนจะห่างกันเกิดสองคะเเนนหรือปล่าว ถ้าคะแนนโหวดของคนที่ให้คะแนนสูงสุด และคะแนนต่ำสุดห่างกันเกินสองคะแนน จะทำให้คนมาดูคะแนนรู้สึกประหลาดใจ เเละ เเสดงผล ว่า Surprising เเต่ถ้าไม่มีโอกาศเเสดง Not notserprising
input 
...
```text
step 1 รับค่าคะเเนนรวม
 รับค่าคะเเนนที่มากที่สุด
step 2 a = นำค่าคะเเนนรวม - คะเเนนที่มากที่สุด
step 3 เทียบว่า a มากกว่า 10 ไหม เเละ  a - 10 > most ถ้ามากกว่า least = a - 10
step 4 elif a < 10 เเละ a < most:
step 5 else: least = a - most
step 6 ดูว่า most - least มากกว่า 2ไหม ใช้พิม Surprising
ไม่ใช้ พิม Not surprising
...
```text
step1 รับค่า total เเละ most เป็น  float

step2 เอาค่ามาสุดคูณสอง เเลเวนำไปลบกับค่าั้งหมด
step3 ดูว่าค่านั้นน้อยกว่า 0ไหมถ้าใช้ ค่านั้นเป็น 0

step4 เอา ค่าที่มากที่สุด มา ลบกับค่าน้อยที่สุดเเล้วดูว่า มากกว่า 2 ไหมมากกว่า ปริ้น surprising
ไม่ ปริ้น Not surprising
```
...
```text
เป็นcase ที่ได้ Not surprising
```
...
```text
ช้วยอธิบายวิธีที่คิดง่ายกว่าเเละผ่านเหมือนกัน
```

คุณยังทำอะไรด้วยตนเอง

```text
ทำทั้งหมดด้วยตัวเองให้ผ่านก่อนเเล้วถ้ามเพื่อนว่าจะทำให้ดีขึ้นได้ยังไง
```
