...
```text
ให้หาจำนวนนับที่อยู่ระหว่าง a เเละ b ที่หารด้วย d เเละเหลือเศษเท่ากับ r ว่ามีกี่ตัว
```
...
```text
loop ระหว่าง a จนถึง b+1 
ดูว่าi modulo d เเล้วเหลือ เท่า เท่ากับ r ไม่ถ้าใช้ count += 1
print(count)
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก loop ระหว่าง a จนถึง b+1  เพราะเวลา Loop  มันจะไปอยุดที่ตัวก่อน b เลยต้อง +1 เข้าไป
```
...
```text
ไม่มีเลขไหนที่ เศาเท่ากับ r เลย
```
...
```text
มีเลขที่หาร เเล้วได้เศษเท่ากับ r
```
