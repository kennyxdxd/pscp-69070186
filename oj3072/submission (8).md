...
```text
โดยโจทย์ต้องการให้นับว่ามีสระอยูในคำเท่าไร
```
...
```text
ทำให้เป็นตัวพิมเล็กก่อน
จากนั้น ใช้ List เก็บค่าสระ
จากนั้นloop ไปใน list สระจากนั้นใช้ .count เพื่อหาว่ามีอยู่กี่ตัว
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก โดยใช้ .count ในการนับ ว่ามีสระเท่าไร เเละปริ้นออกมา
```
