...
```text
โจทย์ให้ คำนวนค่าธรรมเนียมการส่งพัสดุเเละค่าธรรมเนียมน้ำหนักของพัสดุ ตามตารางที่ให้ไว้
input 
บรรทัดที่ 1 รับค่า ต้นทาง ปลายทาง
บรรทัดที่ 2 รับค่า น้ำหนักพัสดุ
output 
เเสดงราคา
Constraints
ให้เเสดงเป็น ทศสนิยมสองเลข
```
...
```text
step 1 รับค่า ต้นทางปลายทาง
step 2 รับค่าน้ำหนัก
step 3 ใช้ dict ในการเก็บเส้นทางเเละค่าธรรมเนียมเเละ ค่าธรรมเนียมน้ำหนัก
step 4 ตรวจว่า ค่าต้นทางปลายทาง อยู่ใน dict หรือปล่าวถ้าอยุ่ให้คำนวนเเล้วprintออก
ไม่ให้ปริ้น error
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก โดยตอนคิด ค่าธรรมเนียมให้เอาค่าเริ้มต้นไป บวกกับ ค่าธรรมเนียมน้ำหนักคูณน้ำหนัก
```
