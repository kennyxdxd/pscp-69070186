...
```text
รับจำนวนเต็มบวกมาเเล้วดูว่าหาร 10 ได้กี่ครั้ง โดย printมาทุกตัว
```
...
```text
วนลูปลงมาโดย เอา เลขไป หารปัดเศษ 10
เเล้วเอา ค่า มาคูณ 10 ไปเรื่อยๆ
```
...
```text
เหมือนแผนแรก ใช้for loop เเล้วใช้ range เป็น range((number//10),-1,-1)
```
