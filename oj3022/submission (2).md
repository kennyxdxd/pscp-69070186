...
```text
โจทย์ต้องการให้เเปลงหน่วยอุณหภูมิเป็นหน่วย จาก หน่วยนึงเป็นอีกหน่วยนึง โดยมี ฟาเรนไฮต์ (F), เคลวิน (K), และแรงคิน (R) จากหน่วยเซลเซียส (C) 
```
...
```text
step 1 รับค่าInput
step2 เช็ก ว่าอุณหภูมิ 1 ของเราคือหน่วยอะไร
step3 เช็กว่าเราต้องเเปลงเป็นหน่วยไหน
step4 คำนวนค่าตามสูตรที่ใช้เเปลง
```
...
```text
เหมือนเพราะ ว่าสามารภเเปลงเป็นหน่วยอืนได้
```
...
```text
เป็น testcase ?ี่เปลียนจาก c ไป f
```
...
```text
เป็น testcase ?ี่เปลียนจาก c ไป k
```
...
```text
เป็น testcase ?ี่เปลียนจาก c ไป r
```
