...
```text
ดูว่าเราเป็นสมาชิกของสหกรโรงเรียนไหม ถ้าใช้ให้ลดราคา 5 % จากยอดซื้อทั้งหมด เเต้ถ้าไม่เป็น สมาชิกเเล้วซื้อของตั้งเเต่ 500 บาทขึ้นไป ให้ลด 3 % 
```
...
```text
รับค่ามา
จาก นั้นเอาค่าจํานวนรายการสินค้าที่ซื้อ มา loopเเล้วบวก เข้าไป ใน count
ใช้ if elif ในการ ดูว่าเป็นสมาชิกไหม ถ้าใช้ให้ลดราคา 5%
เเต่ถ้าไม่ใช้ เเต่ค่าใช่จ่ายมากกว่า 500 ให้ลดราคา 3 %
จากนั้น print ค่าออกมา
input 
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก ใช้ round(count + 1e-9, 2) มาเพื่อ ปัดเศษ
```
...
```text
เป็น case ที่ ไม่เป็นสมาชิก เเต่จำนวนมากกว่า 500
```
