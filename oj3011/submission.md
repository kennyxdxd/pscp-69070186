...
```text
step 1 อ่านค่า Input
step2 ตรวจว่า color1 สีอะไร color2 สีอะไรเเล้วเปรียบเทียบกัน
step3 print๕่าว่าสีอะไร
```
...
```text
step 1 อ่านค่า Input
step2 ตรวจค่าว่าซํ้ากันหรือปล่าว ถ้าซํ้า print สีที่ซํ้ามา
step3 ตรวจว่า color1 สีอะไร color2 สีอะไรเเล้วเปรียบเทียบกัน
step4 printค่าว่าสีอะไร
```
...
```text
เป็นสีสองสีจะได้เปรียบเทียบกันได้
```
...
```text
ผมจำชื่อไม่ได้ครับ เเต่มีคนช่วยผมจริงๆนะครับ
```

เขาช่วยอะไร

```text
ช่วยใบ้testcase เเละจุดที่ผิดต่างๆ
```
