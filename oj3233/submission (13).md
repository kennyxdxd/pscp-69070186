...
```text
เปรียบเทียบสลากกินแบ่งกับผลรางวัล เพื่อหาจำนวนเงินรางวัลที่ได้
Input:
บรรทัดที่ 1: หมวดตัวอักษร และ เลขสลาก 5 หลัก ที่ออกรางวัล 
บรรทัดที่ 2: หมวดตัวอักษร และ เลขสลาก 5 หลัก ที่เราซื้อ 

Output:
จำนวนเงินรางวัลสูงสุดที่ได้รับ (เป็นจำนวนเต็ม) ถ้าไม่ตรงตามเงื่อนไขรางวัลใดเลยให้พิมพ์ 0
```
...
```text
Step 1: รับข้อมูลผลรางวัล
Step 2: รับข้อมูลสลากที่ซื้อ
Step 3: ตรวจสอบเงื่อนไขการรางวัลตามลำดับมูลค่าสูงสุดไปน้อยสุด
ถ้าหมวดตัวอักษรและเลข 5 หลักตรงกันทั้งหมด ได้ 1,000,000 บาท
ถ้าเลข 5 หลักตรงกัน แต่หมวดตัวอักษรไม่ตรง ได้ 100,000 บาท
ถ้าหมวดตัวอักษรตรง และเลขท้าย 3 ตัวตรง ได้ 2,000 บาท
ถ้าหมวดตัวอักษรตรง และเลขท้าย 2 ตัวตรง ได้ 1,000 บาท
ถ้าเลขท้าย 3 ตัวตรง แต่หมวดตัวอักษรไม่ตรง ได้ 200 บาท
ถ้าเลขท้าย 2 ตัวตรง แต่หมวดตัวอักษรไม่ตรง ได้ 100 บาท
ถ้าหมวดตัวอักษรตรง แต่เลขไม่ตรงเลย ได้ 20 บาท

Step 4: ถ้าไม่เข้าเงื่อนไขใดๆ เลย ได้ 0 บาท
Step 5: แสดงผลลัพธ์จำนวนเงินรางวัลที่ได้รับ
```
...
```text
วิธีสุดท้ายของเหมือนกับแผนแรก ใช้ if-else เเยกcase
```
...
```text
หมายเลขทั้ง 5 หลักตรง) แต่ ตัวอักษรไม่ตรง 
```
